...
print(f'Greetings!,',invitation[0],'You are invited for a dinner party at the Benz hotel on Oct 29 at 8:30 pm. Looking forward to meet you')
...
print(f'Heyy!,',invitation[2],'Let us meet for a dinner party at the Benz hotel on Oct 29 at 8:30 pm. It was long week let us take some break and enjoy our day')
...
print(f'Good Morning!,',invitation[1],'Why dont we get together at the Benz hotel on Oct 29 at 8:30 pm? We all will have lots of fun')
print(f'Heyy!,',invitation[2],'Let us meet for a dinner party at the Benz hotel on Oct 29 at 8:30 pm. It was long week let us take some break and enjoy our day')
print('My dinner table won’t arrive in time for the dinner, so because of that we have space only fpr two people')
